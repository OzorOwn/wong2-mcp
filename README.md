...
- **[DeFi MCP](https://github.com/OzorOwn/defi-mcp)** - DeFi data server with 12 tools: token prices via CoinGecko, wallet balances across 7 EVM chains, gas prices, DEX swap quotes via Jupiter (Solana) and 1inch (EVM), and portfolio analytics.
