...
- **[Spawnpay](https://github.com/Robocular/spawnpay)** - USDC wallets, payments, and referral earnings for AI agents on Base L2. Auto-creates a wallet on first use (no signup, no KYC). 9 tools, MIT licensed. Install: `npx spawnpay-mcp`.
